...
def log_hyperparameters(
    ...
    Args:
        ...
        datamodule (pl.LightningDataModule): Data module to be trained.
        trainer (pl.Trainer): Trainer to be trained.
        callbacks (List[pl.Callback]): Callbacks to be trained.
        logger (List[pl.loggers.LightningLoggerBase]): Loggers to be trained.
    """
